...
module enclosure_body() { color("#F8F8F8") {
                minkowski() {
        cube([52.00, 13.00, 82.00], center=true);
        sphere(r=4.00, $fn=24);
    }
}
...
module enclosure_lid() { color("#F8F8F8") {
                minkowski() {
        cube([54.00, 0.10, 84.00], center=true);
        sphere(r=3.00, $fn=24);
    }
}
...
module vent_slots() {
    translate([-23.33, 0, d/2 - 3])
        cube([1.5, 25, 1], center=true);
    translate([-16.67, 0, d/2 - 3])
        cube([1.5, 25, 1], center=true);
    translate([-10.00, 0, d/2 - 3])
        cube([1.5, 25, 1], center=true);
    translate([-3.33, 0, d/2 - 3])
        cube([1.5, 25, 1], center=true);
    translate([3.33, 0, d/2 - 3])
        cube([1.5, 25, 1], center=true);
    translate([10.00, 0, d/2 - 3])
...
module display_bezel() {
    difference() {
        translate([0, 0, h/2])
            cube([45.00, 58.50, 2], center=true);
        translate([0, 0, h/2 + 1])
            cube([45.00 - 8, 58.50 - 8, 4], center=true);
    }
}
