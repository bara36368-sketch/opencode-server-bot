...
module enclosure_body() { color("#0D0D0D") {
                minkowski() {
        cube([92.00, 13.00, 82.00], center=true);
        sphere(r=4.00, $fn=24);
    }
}
...
module enclosure_lid() { color("#0D0D0D") {
                minkowski() {
        cube([94.00, 0.10, 84.00], center=true);
        sphere(r=3.00, $fn=24);
    }
}
...
module vent_slots() {
    translate([-38.89, 0, d/2 - 3])
        cube([1.5, 25, 1], center=true);
    translate([-27.78, 0, d/2 - 3])
        cube([1.5, 25, 1], center=true);
    translate([-16.67, 0, d/2 - 3])
        cube([1.5, 25, 1], center=true);
    translate([-5.56, 0, d/2 - 3])
        cube([1.5, 25, 1], center=true);
    translate([5.56, 0, d/2 - 3])
        cube([1.5, 25, 1], center=true);
    translate([16.67, 0, d/2 - 3])
...
module display_bezel() {
    difference() {
        translate([0, 0, h/2])
            cube([75.00, 58.50, 2], center=true);
        translate([0, 0, h/2 + 1])
            cube([75.00 - 8, 58.50 - 8, 4], center=true);
    }
}
