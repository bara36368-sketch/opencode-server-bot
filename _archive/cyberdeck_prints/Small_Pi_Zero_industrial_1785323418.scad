...
module enclosure_body() { color("#1A1A1A") {
                minkowski() {
        cube([72.00, 13.00, 82.00], center=true);
        sphere(r=4.00, $fn=24);
    }
}
...
module enclosure_lid() { color("#1A1A1A") {
                minkowski() {
        cube([74.00, 0.10, 84.00], center=true);
        sphere(r=3.00, $fn=24);
    }
}
...
module vent_slots() {
    translate([-31.11, 0, d/2 - 3])
        cube([1.5, 25, 1], center=true);
    translate([-22.22, 0, d/2 - 3])
        cube([1.5, 25, 1], center=true);
    translate([-13.33, 0, d/2 - 3])
        cube([1.5, 25, 1], center=true);
    translate([-4.44, 0, d/2 - 3])
        cube([1.5, 25, 1], center=true);
    translate([4.44, 0, d/2 - 3])
        cube([1.5, 25, 1], center=true);
    translate([13.33, 0, d/2 - 3])
...
module display_bezel() {
    difference() {
        translate([0, 0, h/2])
            cube([60.00, 58.50, 2], center=true);
        translate([0, 0, h/2 + 1])
            cube([60.00 - 8, 58.50 - 8, 4], center=true);
    }
}
