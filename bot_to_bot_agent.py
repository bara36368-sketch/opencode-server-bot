...
class BotToBotManager:
    ...
    def _setup_default_agents(self):
        configs = [
            ...
            AgentConfig(id="cyberdeck", name="Cyberdeck Builder", agent_type=AgentType.CYBERDECK, capabilities=["electronics picking", "3d printing", "enclosure design", "bom generation", "compatibility checking", "soldering guidance", "component selection", "image analysis", "video learning", "pcb database", "wire database", "connectivity database", "tier system", "tutorial generation", "code generation", "idea generation", "flaw fixing", "cable routing", "pack generation", "build optimization", "continuous evolution"], prompt="You are a cyberdeck and electronics expert v4.0. Help users design, pick components, build, and troubleshoot cyberdecks and portable computing projects. You have access to SBC, display, keyboard, power, enclosure, cooling, PCB, wire, and connectivity databases with the best components per category. Always validate 100% compatibility before recommending. Enforce WiFi/LAN and cooling in every build. Generate cable routing plans and build packs. Detect and auto-fix flaws. Learn from every interaction."),
        ]
