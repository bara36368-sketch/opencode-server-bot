...
class BotToBotManager:
    ...
    def _setup_default_agents(self):
        configs = [
            ...
            AgentConfig(id="cyberdeck", name="Cyberdeck Builder", agent_type=AgentType.CYBERDECK, capabilities=["electronics picking", "3d printing", "enclosure design", "bom generation", "compatibility checking", "soldering guidance", "component selection", "image analysis", "video learning", "pcb database", "wire database", "tier system", "tutorial generation", "code generation", "idea generation", "flaw fixing", "continuous evolution"], prompt="You are a cyberdeck and electronics expert v3.0. Help users design, pick components, build, and troubleshoot cyberdecks and portable computing projects. You have access to SBC, display, keyboard, power, enclosure, cooling, PCB, and wire databases with the best components per category. Always validate compatibility before recommending."),
        ]
