...
module enclosure_body() { color("#1A1A1A") {
                minkowski() {
        cube([492.00, 112.00, 392.00], center=true);
        sphere(r=4.00, $fn=24);
    }
}
...
module enclosure_lid() { color("#1A1A1A") {
                minkowski() {
        cube([494.00, 0.10, 394.00], center=true);
        sphere(r=3.00, $fn=24);
    }
}
...
module vent_slots() {
    translate([-194.44, 0, d/2 - 3])
        cube([1.5, 25, 1], center=true);
    translate([-138.89, 0, d/2 - 3])
        cube([1.5, 25, 1], center=true);
    translate([-83.33, 0, d/2 - 3])
        cube([1.5, 25, 1], center=true);
    translate([-27.78, 0, d/2 - 3])
        cube([1.5, 25, 1], center=true);
    translate([27.78, 0, d/2 - 3])
        cube([1.5, 25, 1], center=true);
    translate([83.33, 0, d/2 - 3])
...
module cable_channel() {
    color("#505050") {
        difference() {
            translate([-500.00/2 + 3, 0, -h/2 + 2])
                cube([4, 400.00 - 10, 4], center=true);
            translate([-500.00/2 + 3, 0, -h/2 + 2])
                cube([2.4, 400.00 - 8, 5], center=true);
        }
    }
}
...
module display_bezel() {
    difference() {
        translate([0, 0, h/2])
            cube([375.00, 260.00, 2], center=true);
        translate([0, 0, h/2 + 1])
            cube([375.00 - 8, 260.00 - 8, 4], center=true);
    }
}
...
module accent_lines() {
    color("#FFD700") {
        translate([0, -188.00, h/2 + 2])
            cube([w - 24, 1.2, 0.5], center=true);
        translate([0, -62.67, h/2 + 2])
            cube([w - 24, 1.2, 0.5], center=true);
        translate([0, 62.67, h/2 + 2])
            cube([w - 24, 1.2, 0.5], center=true);
        translate([0, 188.00, h/2 + 2])
