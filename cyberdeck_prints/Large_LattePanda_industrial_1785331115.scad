...
module enclosure_body() { color("#1A1A1A") {
                minkowski() {
        cube([152.00, 22.00, 112.00], center=true);
        sphere(r=4.00, $fn=24);
    }
}
...
module enclosure_lid() { color("#1A1A1A") {
                minkowski() {
        cube([154.00, 0.10, 114.00], center=true);
        sphere(r=3.00, $fn=24);
    }
}
...
module vent_slots() {
    translate([-62.22, 0, d/2 - 3])
        cube([1.5, 25, 1], center=true);
    translate([-44.44, 0, d/2 - 3])
        cube([1.5, 25, 1], center=true);
    translate([-26.67, 0, d/2 - 3])
        cube([1.5, 25, 1], center=true);
    translate([-8.89, 0, d/2 - 3])
        cube([1.5, 25, 1], center=true);
    translate([8.89, 0, d/2 - 3])
        cube([1.5, 25, 1], center=true);
    translate([26.67, 0, d/2 - 3])
...
module cable_channel() {
    color("#505050") {
        difference() {
            translate([-160.00/2 + 3, 0, -h/2 + 2])
                cube([4, 120.00 - 10, 4], center=true);
            translate([-160.00/2 + 3, 0, -h/2 + 2])
                cube([2.4, 120.00 - 8, 5], center=true);
        }
    }
}
...
module display_bezel() {
    difference() {
        translate([0, 0, h/2])
            cube([120.00, 78.00, 2], center=true);
        translate([0, 0, h/2 + 1])
            cube([120.00 - 8, 78.00 - 8, 4], center=true);
    }
}
...
module accent_lines() {
    color("#FFD700") {
        translate([0, -48.00, h/2 + 2])
            cube([w - 24, 1.2, 0.5], center=true);
        translate([0, -16.00, h/2 + 2])
            cube([w - 24, 1.2, 0.5], center=true);
        translate([0, 16.00, h/2 + 2])
            cube([w - 24, 1.2, 0.5], center=true);
        translate([0, 48.00, h/2 + 2])
